...
Cheat_Menu.append_enemy_cheats = function(key1, key2) {
	Cheat_Menu.append_cheat("敌人 HP 到 0", "激活", key1, Cheat_Menu.enemy_hp_cheat_1);
	Cheat_Menu.append_cheat("敌人 HP 到 1", "激活", key2, Cheat_Menu.enemy_hp_cheat_2);
};
...
Cheat_Menu.append_party_cheats = function(key1, key2, key3) {
	Cheat_Menu.append_cheat("队友 HP 到 0", "激活", key1, Cheat_Menu.party_hp_cheat_1);
	Cheat_Menu.append_cheat("队友 HP 到 1", "激活", key2, Cheat_Menu.party_hp_cheat_2);
	Cheat_Menu.append_cheat("队友全部恢复", "激活", key3, Cheat_Menu.party_recovery_cheat);
};
...
Cheat_Menu.append_no_clip_status = function(key1) {
	var status_text;
	if ($gamePlayer._through) {
		status_text = "<font color='#00ff00'>开</font>";
	}
	else {
		status_text = "<font color='#ff0000'>关</font>";
	}
...
Cheat_Menu.append_save_recall = function (key1, key2, key3, key4, key5, key6) {
	...
	for (var i = 0; i < Cheat_Menu.saved_positions.length; i++) {
		...
		Cheat_Menu.append_cheat("载入:", pos_text, eval("key" + cur_key), Cheat_Menu.recall_position.bind(null, i));
		cur_key++;
	}
};
...
Cheat_Menu.append_teleport = function (key1, key2, key3, key4, key5, key6, key7) {
	...
	Cheat_Menu.append_cheat("传送", "激活", key7, Cheat_Menu.teleport_current_location);
};
...
Cheat_Menu.menus.splice(0, 0, function() {
	Cheat_Menu.append_cheat_title("保存并载入");
...
Cheat_Menu.menus.splice(0, 0, function() {
	Cheat_Menu.append_cheat_title("防具");
	Cheat_Menu.append_amount_selection(4, 5);
...
Cheat_Menu.menus.splice(0, 0, function() {
	Cheat_Menu.append_cheat_title("状态");
	Cheat_Menu.append_actor_selection(4, 5);
...
Cheat_Menu.menus.splice(0, 0, function() {
	Cheat_Menu.append_cheat_title("给予经验值");
	Cheat_Menu.append_actor_selection(4, 5);
	Cheat_Menu.append_amount_selection(6, 7);
...
Cheat_Menu.menus.splice(0, 0, function() {
	Cheat_Menu.append_cheat_title("敌人/队友 生命");
